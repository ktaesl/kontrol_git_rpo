# Git Practice: [Сысуева Екатерина]
...
Первым этапом, я клонировала репохиторий к себе на компьютер, и создала копию в GitHub. Далее, я проверила, что проект инициализирован. Также я проверила, что есть файл .gitignore и в нем зафиксированы все файлы, которые не надо отслеживать. После этого я зафиксировала изменения.
...
Fetch запечатляет внешние изменения, а Pull фиксирует их. 
...
>>>>>>> df4262baea71eb848994d41605ea66c5dbaa7d7d
